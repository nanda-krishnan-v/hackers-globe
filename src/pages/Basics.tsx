...
const Basics = () => {
  useEffect(() => {
    document.title = "Cybersecurity Basics: IP, MAC, TCP, OSI";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute(
        "content",
        "Understand IP vs MAC addresses, TCP fundamentals, and the OSI model with clear, beginner-friendly explanations."
      );
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="container mx-auto px-4 pt-12 pb-6">
        <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Cybersecurity Basics</h1>
      ...
      <main className="container mx-auto px-4 pb-16">
        <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4" aria-label="Concept overview">
          <Card>
            <CardHeader>
        ...
        <section className="mt-12" aria-label="OSI layers in detail">
          <h2 className="text-2xl font-semibold tracking-tight mb-4">OSI Layers Explained</h2>
        ...
        <section className="mt-12" aria-label="How it all works together">
          <h2 className="text-2xl font-semibold tracking-tight mb-3">How They Work Together</h2>
          <Card>
